...
var botToken = "OTU3NTQ2ODgzNTI0NDcyODMy.GFvRJm.mTeqs7AzIK45wJy5x90kfGCZ7BWQUAoOOvBdmk"; // This must be a Discord bot token, create a bot @ https://discord.com/developers/applications
...
var notWhitelistedMessage = "Kamu Belum Belum Whitelisted Di Server Discord. Kamu Harus Bergabung Ke Discord : https://discord.gg/pmqpmtdeFf .";
var noGuildMessage = "Discord tidak terdeteksi. Sepertinya Kamu Belum Gabung Ke Discord : https://discord.gg/pmqpmtdeFf .";
var blacklistMessage = "Kamu Di Blacklist Dari Server Ini. Hubungi Admin Discord : https://discord.gg/pmqpmtdeFf ";
var debugMode = false; // 
...
on('playerConnecting', async (name, setKickReason, deferrals) => {
    ...
    deferrals.defer();
    setTimeout(() => {
        deferrals.update(`Hello ${name}. ID Discord Anda sedang diperiksa Sebagai Whitelisted.`)
