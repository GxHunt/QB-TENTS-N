...
QBCore.Functions.CreateUseableItem("mystery_smallbox", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-mysteryboxes:client:AbrirPequena', source)
    end
end)
...
QBCore.Functions.CreateUseableItem("mystery_mediumbox", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-mysteryboxes:client:AbrirMedia', source)
    end
end)
...
QBCore.Functions.CreateUseableItem("mystery_bigbox", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-mysteryboxes:client:AbrirGrande', source)
    end
end)
...
QBCore.Functions.CreateUseableItem("mystery_expensivebox", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-mysteryboxes:client:AbrirSuper', source)
    end
end)

RegisterNetEvent('qb-mysteryboxes:server:ComprarPequena', function()
    local src = source
...
RegisterNetEvent('qb-mysteryboxes:server:ComprarMedia', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-mysteryboxes:server:ComprarGrande', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-mysteryboxes:server:ComprarSuper', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-mysteryboxes:server:RewardPequena', function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent('qb-mysteryboxes:server:RewardMedia', function()
    local Player = QBCore.Functions.GetPlayer(source)
    local probabilidade = math.random(1, 100)
...
RegisterNetEvent('qb-mysteryboxes:server:RewardGrande', function()
    local Player = QBCore.Functions.GetPlayer(source)
    local probabilidade = math.random(1, 100)
...
RegisterNetEvent('qb-mysteryboxes:server:RewardSuper', function()
    local Player = QBCore.Functions.GetPlayer(source)
    local probabilidade = math.random(1, 100)
