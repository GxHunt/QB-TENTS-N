...
RegisterNetEvent('qb-mysteryboxes:client:ComprarCaixa', function(args, data)
    local args = tonumber(args)

    if args == 1 then
        TriggerServerEvent('qb-mysteryboxes:server:ComprarPequena')
    elseif args == 2 then
        TriggerServerEvent('qb-mysteryboxes:server:ComprarMedia')
    elseif args == 3 then
        TriggerServerEvent('qb-mysteryboxes:server:ComprarGrande')
    elseif args == 4 then
        TriggerServerEvent('qb-mysteryboxes:server:ComprarSuper')
    end
end)

RegisterNetEvent('qb-mysteryboxes:client:ComprarCaixas', function()
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            txt = "Price: 100$",
            params = {
                event = "qb-mysteryboxes:client:ComprarCaixa",
                args = 1,
            }
        },
        {
...
CreateThread(function()
    ...
    exports['qb-target']:AddBoxZone("MysteryShopPed", Config.ShopPed['PedTarget'], 1, 1, {
        ...
        options = {
            {
                event = "qb-mysteryboxes:client:ComprarCaixas",
...
RegisterNetEvent('qb-mysteryboxes:client:AbrirPequena', function()
    ...
    QBCore.Functions.Progressbar('name_here', 'OPENING MYSTERY BOX...', 5000, false, true, {
        ...
        TriggerServerEvent('qb-mysteryboxes:server:RewardPequena')
    end)
end)

RegisterNetEvent('qb-mysteryboxes:client:AbrirMedia', function()
    local playerPed = PlayerPedId()
    local coords    = GetEntityCoords(playerPed)
    local forward   = GetEntityForwardVector(playerPed)
    local x, y, z   = table.unpack(coords + forward * 1.0)
    ...
    QBCore.Functions.Progressbar('name_here', 'OPENING MYSTERY BOX...', 5000, false, true, {
        ...
        TriggerServerEvent('qb-mysteryboxes:server:RewardMedia')
    end)
end)

RegisterNetEvent('qb-mysteryboxes:client:AbrirGrande', function()
    local playerPed = PlayerPedId()
    local coords    = GetEntityCoords(playerPed)
    local forward   = GetEntityForwardVector(playerPed)
    local x, y, z   = table.unpack(coords + forward * 1.0)
    ...
    QBCore.Functions.Progressbar('name_here', 'OPENING MYSTERY BOX...', 5000, false, true, {
        ...
        TriggerServerEvent('qb-mysteryboxes:server:RewardGrande')
    end)
end)

RegisterNetEvent('qb-mysteryboxes:client:AbrirSuper', function()
    local playerPed = PlayerPedId()
    local coords    = GetEntityCoords(playerPed)
    local forward   = GetEntityForwardVector(playerPed)
    local x, y, z   = table.unpack(coords + forward * 1.0)
    ...
    QBCore.Functions.Progressbar('name_here', 'OPENING MYSTERY BOX...', 5000, false, true, {
        ...
        TriggerServerEvent('qb-mysteryboxes:server:RewardSuper')
    end)
end)