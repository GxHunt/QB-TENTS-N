...
Config.FishingWaitTime = {minTime = 18000, maxTime = 32000}     -- How long a player will be waiting to fish, during or after casting fishingrod
...
Config.largeLootboxRewards = {                                  -- Rewards found in the treasure chest (keep price = 0)
    [1] = { name = "kurkakola", price = 0, amount = 2, info = {}, type = "item", slot = 1, },
	[2] = { name = "tosti", price = 0, amount = 2, info = {}, type = "item", slot = 2, },
    [3] = { name = "fishbait", price = 0, amount = 5, info = {}, type = "item", slot = 3, },
    [4] = { name = "aluminum", price = 0, amount = 1, info = {}, type = "item", slot = 4, },
